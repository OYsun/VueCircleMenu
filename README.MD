...
### type
`type`参数是必填项，指明菜单的类型，一共有一下六种：top,botoom,left,right,middle,middle-around
...
- 通过`solt`，可以填写任何内容，并且自定义样式
```html
  <cirecle-menu type="top">
    <button type="button" slot="item_btn"></button>
    <i slot="item_1" class="fa fa-twitter fa-lg"></i>
    <span slot="item_2"></a>
    <div slot="item_3"></a>
...
```html
  <cirecle-menu type="middle-around">
    ...
    <a slot="item_1" herf="#" ></a>
    <a slot="item_2" herf="#" ></a>
    <a slot="item_3"></a>
    <a slot="item_4"></a>
  </cirecle-menu>
```
